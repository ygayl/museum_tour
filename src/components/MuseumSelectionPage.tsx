...
interface MuseumSelectionPageProps {
  museums: Museum[];
  onSelectMuseum: (museum: Museum) => void;
}

const MuseumSelectionPage: React.FC<MuseumSelectionPageProps> = ({ museums, onSelectMuseum }) => {
  return (
            ...
            <div className="relative h-48">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-end">
                <div className="p-4 text-white">
                  <h3 className="text-xl font-bold mb-1">{museum.name}</h3>
                  <p className="text-sm opacity-90">{museum.theme}</p>
                </div>
              </div>
            </div>
            
            <div className="p-4">
              <p className="text-gray-600 text-sm mb-3">{museum.description}</p>
...
export default MuseumSelectionPage;